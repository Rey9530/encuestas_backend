...
namespace encuestasbackend.Migrations
{
    ...
    [Migration("20230220213055_addPreguntasRespuestas2")]
    partial class addPreguntasRespuestas2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("encuestas_backend.Entidades.CuestionarioPreguntasRespuestas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CuestionarioPreguntasRespuestas");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("encuestas_backend.Entidades.UserCustom", null)
                        .WithMany()
            ...
            modelBuilder.Entity("encuestas_backend.Entidades.CuestionarioPreguntasRespuestas", b =>
                {
                    b.HasOne("encuestas_backend.Entidades.CuestionarioPreguntas", "Pregunta")
                        .WithMany()
